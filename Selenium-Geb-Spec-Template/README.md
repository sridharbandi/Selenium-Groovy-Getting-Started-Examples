## Selenium Geb ([Gebish](http://www.gebish.org/)) Groovy Spock Template with Gradle or Maven as build tools to getting started with
...
### How to use?
Create the Page Objects of your Web application under **_pageobjects_** package and call those Page Objects in your spock tests under **_tests_** package (Sample Page Objects, testcase included in this template)
